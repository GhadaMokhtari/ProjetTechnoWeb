...
CREATE TABLE APP.DISCOUNT_CODE (
	DISCOUNT_CODE CHAR(1) NOT NULL 
            CONSTRAINT UppercaseCharacter CHECK (DISCOUNT_CODE BETWEEN 'A' AND 'Z'),
	RATE DECIMAL(5,3)
            CONSTRAINT NonNegativeRate CHECK (RATE >= 0.0),
